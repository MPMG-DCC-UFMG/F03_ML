...
class Item:
    ...
    def extract_entities(self, description, id_hom_licitacao, licitacao_item,
                         licitacao, price, dsc_unidade, original, ano,
                         set_unit_metrics, set_colors, set_materials, set_sizes,
                         set_quantities, set_qualifiers, set_numbers, set_ambiguous,
                         stopwords):
        '''
        ...
        self.id_hom_licitacao = id_hom_licitacao
    ...
    def load_item(self, item, original):
        ...
        self.id_hom_licitacao = item['id_hom_licitacao']
    ...
    def get_item_dict(self):
        ...
        item_dict = {
            ...
            'id_hom_licitacao': self.id_hom_licitacao
        }
